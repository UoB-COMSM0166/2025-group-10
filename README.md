...
<img src="docs/repoPic/Onion.jpg" alt="Onion Diagram" width="30%"/>
...
### Tools
<img src="docs/repoPic/KanBan.png" alt="Kanban" width="100%"/>
...
| Naiwen Tsui      | 1.00 |   |
| Zhu Xuefei       | 1.00 |   |
| Pinchun Shen     | 1.00 | - Designed the game concept and story background. 
- Visual design of the main character, game background, and objects.
- Coded the instruction and ending pages.
- Wrote the report.
- Made the video.  |
| Chih Hsien Ho    | 1.00 |   |
| Cyunwun Lin      | 1.00 |   |
